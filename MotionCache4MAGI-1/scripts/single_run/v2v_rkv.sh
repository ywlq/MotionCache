...
python3 inference/pipeline/rkv.py \
    --config_file config/single_run/rkv.json \
    --mode v2v \
    ...
    --prefix_video_path "/path/to/physics-IQ-benchmark/physics-IQ-benchmark/split-videos/conditioning/24FPS/0001_conditioning-videos_24FPS_perspective-left_take-1_trimmed-ball-and-block-fall.mp4" \
